...
import sys
sys.path.append('/root/project/huzheng/model/GraphEmbedding-master')
...
class BERT(nn.Module):
    def __init__(self, config):
        ...
        self.encoder_layer = nn.TransformerEncoderLayer(d_model=hidden, nhead=heads,dim_feedforward=hidden * 4\
